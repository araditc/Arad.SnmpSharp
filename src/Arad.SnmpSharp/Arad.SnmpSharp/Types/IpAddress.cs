...
public class IpAddress : Octetstring, IComparable, ICloneable
{
    ...
    public IpAddress NetworkMask()
    {
        ...
        {
            case 1:
                return new(new byte[] { 255, 0, 0, 0 });
            case 2:
                return new(new byte[] { 255, 255, 0, 0 });
            case 3:
                return new(new byte[] { 255, 255, 255, 0 });
            default:
                return null;
        }
    }
    ...
    public IpAddress Increment(UInt32 count)
    {
        ...
        revip += count;
        return new(ReverseByteOrder(revip));
    }
