...
public class Oid: AsnType, ICloneable, IComparable, IEnumerable<UInt32>
{
    ...
    public override void encode(MutableByte buffer)
    {
        ...
        if (values[0] < 0 || values[0] > 2)
            throw new SnmpException.SnmpException("Invalid Object Identifier");
