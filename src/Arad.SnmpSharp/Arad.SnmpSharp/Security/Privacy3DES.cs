...
namespace Arad.SnmpSharp.Security
{
	...
	/// this privacy protocol and for the completeness of the library, it has been included in AradSnmpSharp.
	/// 
	/// Troubleshooting of TripleDES encryption is difficult because of the low availability so if you find problems
	/// with the AradSnmpSharp implementation, please try to provide me with as much detail, both about your code and
