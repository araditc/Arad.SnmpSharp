...
public class SnmpV2Packet: SnmpPacket
{
    ...
    public override byte[] encode()
    {
        ...
        if (this.Pdu.Type != PduType.Get && this.Pdu.Type != PduType.GetNext &&
            ...
            throw new SnmpInvalidPduTypeException("Invalid SNMP PDU type while attempting to encode PDU: " + $"0x{this.Pdu.Type:x2}");
    ...
    public static SnmpV2Packet BuildInformResponse(SnmpV2Packet informPacket)
    {
        ...
        SnmpV2Packet response = new(informPacket.Community.ToString());
