...
public class TrapAgent
{
    ...
    public TrapAgent()
    {
        _sock = new(AddressFamily.InterNetwork, SocketType.Dgram, ProtocolType.Udp);
    ...
    {
        SnmpV1TrapPacket packet = new(community);
    ...
    {
        SnmpV2Packet packet = new(community);
    ...
    public static void SendTrap(SnmpPacket packet, IpAddress peer, int port)
    {
        ...
        if (packet is SnmpV1TrapPacket)
            ...
            throw new SnmpException.SnmpException("Invalid SNMP packet type.");
    }
}